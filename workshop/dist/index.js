...
var UserReducer_1 = __webpack_require__(/*! ./reducers/UserReducer */ "./ts/reducers/UserReducer.ts");
// 複数の reducer を束ねる
var combinedReducer = redux_1.combineReducers({
    User: UserReducer_1.UserReducer,
});
// グローバルオブジェクトとして、store を作成する。
var store = redux_1.createStore(combinedReducer); // --(c)
exports.default = store;


/***/ }),

/***/ "./ts/actions/UserEvents.ts":
/*!**********************************!*\
  !*** ./ts/actions/UserEvents.ts ***!
  \**********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var uuid_1 = __webpack_require__(/*! uuid */ "./node_modules/uuid/index.js"); // -- (a)
/**
 * ユーザー名を変更するアクション・タイプ
 */
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = __importDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js")); // --(a);
/**
 * ラベル付きのテキストボックスを提供する
 */
var TextBox = /** @class */ (function (_super) {
    ...
    function TextBox() {
        ...
        _this.onChnageText = function (e) {
            _this.props.onChnageText(e.target.value);
        };
        return _this;
    }
    // DOMエレメントをレンダリングする
    TextBox.prototype.render = function () {
        ...
        return (react_1.default.createElement("span", null,
            label /* --(e) */,
            react_1.default.createElement("input", { name: "username", type: this.props.type, value: this.props.value, onChange: this.onChnageText }),
            " "));
    };
    return TextBox;
...
var UserEvents_1 = __webpack_require__(/*! ../actions/UserEvents */ "./ts/actions/UserEvents.ts");
var Store_1 = __importDefault(__webpack_require__(/*! ../Store */ "./ts/Store.ts"));
var TextBox_1 = __webpack_require__(/*! ./TextBox */ "./ts/components/TextBox.tsx");
/**
 * ユーザー名を入力して表示する
 */
var UserForm = /** @class */ (function (_super) {
    ...
    function UserForm() {
        ...
        _this.onChangeText = function (value) {
            Store_1.default.dispatch(UserEvents_1.createChangeUserNameAction(value));
        };
        return _this;
    }
    UserForm.prototype.render = function () {
        return (react_1.default.createElement("div", null,
            react_1.default.createElement("p", null,
                react_1.default.createElement(TextBox_1.TextBox, { label: "\u30E6\u30FC\u30B6\u30FC\u540D", type: "text", value: this.props.name, onChnageText: this.onChangeText }),
                " "),
            react_1.default.createElement("p", null,
                "\u540D\u524D: ",
                this.props.name)));
...
exports.default = react_redux_1.connect(mapStateToProps)(UserForm);
...
var react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
var UserForm_1 = __importDefault(__webpack_require__(/*! ./components/UserForm */ "./ts/components/UserForm.tsx"));
var Store_1 = __importDefault(__webpack_require__(/*! ./Store */ "./ts/Store.ts"));
var container = document.getElementById('contents');
react_dom_1.default.render(react_1.default.createElement(react_redux_1.Provider, { store: Store_1.default },
    react_1.default.createElement(UserForm_1.default, null)), container);
...
Object.defineProperty(exports, "__esModule", { value: true });
var clone_1 = __importDefault(__webpack_require__(/*! clone */ "./node_modules/clone/clone.js"));
var UserEvents_1 = __webpack_require__(/*! ../actions/UserEvents */ "./ts/actions/UserEvents.ts");
var IUser_1 = __webpack_require__(/*! ../states/IUser */ "./ts/states/IUser.ts");
exports.UserReducer = function (childState, action) {
    ...
    switch (action.type) {
        case UserEvents_1.CHANGE_USER_NAME: // --(c)
            {
